...
export default function TrendingpageCollection() {
  ...
  const supremeProducts = product.products?.content?.filter((item) =>
  item.category.name === "nike" || item.category.name === "starbucks"
) || [];
      ...
      <main className="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
        <div className="border-b border-gray-200 pb-10">
          <h1 className="text-4xl font-extrabold tracking-tight text-gray-900">
            Trendingpage Collection
          </h1>
          <p className="mt-4 text-base text-gray-500">
          Discover the Essence of Elegance Explore the Trendingpage Collection
          </p>
        </div>
