...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="bg-white">
      <div className="max-w-2xl lg:py-16 px-4 sm:py-24 sm:mb-0 sm:px-6 lg:max-w-7xl lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-x-4 gap-y-10 sm:gap-x-6 lg:gap-x-8">
          {displayedProducts.map((product) => (
            ...
            >
              <div className="w-full h-56 bg-gray-200 rounded-xl border overflow-hidden group-hover:opacity-75 lg:h-72 xl:h-80">
                <img
              ...
              <div className="flex flex-row justify-center mt-4">
                <p className="  md-font text-center text-gray-500 mb-5 font-bold text-lg line-through mr-3 ">
                  ₹{product.price}
                </p>

                <p className="  md-font text-center text-gray-900 mb-5 font-bold text-lg ">
                  ₹{product.discountedPrice}
                </p>
                <p className=" md-font text-center text-orange-500  mb-5  font-bold text-lg ml-2">
              ...
              <div className="hidden md:block">
                <button
                  className="quick-view-button absolute top-[15rem] text-center pt-2 pb-2 pr-10 pl-10 ml-[57px] bg-gray-600 text-white rounded-md opacity-0 group-hover:opacity-75"
                  onClick={(e) => {
                    e.stopPropagation();
                    ...
                    <div className="sm:col-span-8 lg:col-span-7">
                      ...
                      >
                        ...
                        <div className="flex flex-row mt-3">
                          ...
                          <p className=" text-center text-green-500 font-bold text-lg ml-2">
