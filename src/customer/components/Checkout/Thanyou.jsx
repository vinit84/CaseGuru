      ...
      <>
        ...
        */}
        <main className="relative lg:min-h-full">
          <div className="h-80 overflow-hidden lg:absolute lg:w-1/2 lg:h-full lg:pr-4 xl:pr-12 font-['Gilroy']">
            <img
          ...
          <div>
            <div className="max-w-2xl mx-auto py-16 px-4 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8 lg:py-32 lg:grid lg:grid-cols-2 lg:gap-x-8 xl:gap-x-24">
              <div className="lg:col-start-2 font-['Gilroy']">
                <h1 className="text-md font-['Gilroy'] font-bold text-orange-600">Payment successful</h1>
                <p className="mt-2 text-4xl font-extrabold font-['Gilroy'] tracking-tight text-gray-900 sm:text-5xl">
                  Thanks for ordering
                </p>
                ...
                <dl className="mt-16 text-sm font-medium">
                  ...
                  <dd className="mt-2 text-orange-600">51547878755545848512</dd>
                </dl>
